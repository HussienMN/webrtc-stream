    ...
    <div class="videoStream">
        <div id="board" v-if="isStreaming">
            ...
            <div v-if="isJoined">
                ...
                <button ref="leaveRoom" v-on:click="leaveRoom" class="btn" v-if="teilnehmer">
        ...
        <div class="remote-streams" ref='remoteVideo' id="remoteVideo" v-if="isJoined">
        ...
        joinRoom: function(){
            ...
            // alert(this.roomName)
                ...
                this.konferenzRaum.on('stream', (stream)=>{
                    ...
                    videoElement.setAttribute('ref', 'videoElement');
